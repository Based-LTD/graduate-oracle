...
async function request(path, opts = {}) {
    const { method = "GET", body, headers = {}, withAuth = true, timeoutMs = 20_000, } = opts;
...
export function authMissingMessage() {
    return ("graduate-oracle API key not configured. " +
