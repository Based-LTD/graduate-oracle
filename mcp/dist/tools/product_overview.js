...
export const product_overview = {
    ...
    description: "Get an overview of graduate-oracle: what it does, what each of the other " +
    ...
    async handler() {
        const overview = {
            ...
            pitch: "We do NOT replace your LLM trader. We give it senses. graduate-oracle scores every " +
            ...
            receipts_discipline: "Every single prediction is hashed with a SHA256 commitment BEFORE the outcome is " +
